...
x=estimateEmbeddingDim(ik$x,time.lag=1,max.embedding.dim=6,threshold=0.9,do.plot=TRUE)
checkEquals(4,x)
x=estimateEmbeddingDim(h$x,time.lag=1,max.embedding.dim=6,threshold=0.9,do.plot=TRUE)
checkEquals(2,x)
x=estimateEmbeddingDim(l$x,time.lag=15,max.embedding.dim=6,threshold=0.9,do.plot=TRUE)
checkEquals(4,x)
#estimateEmbeddingDim(brown_noise,time.lag=1,max.embedding.dim=15,theiler.window=100,threshold=0.9)
