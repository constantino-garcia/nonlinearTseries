...
test_that("estimates equal theoretical results", {
  ...
  expect_equal(1.250462, estimate(x), tolerance = 10 ^ -2)
  ...
  expect_equal(1.211371, estimate(x), tolerance=10^-2)
  ...
  expect_equal(2.095474, estimate(x), tolerance = 6 * 10 ^ -2)
  ...
  # message("expected: 1.26  estimate: ",estimate(x),"\n")
  expect_equal(1.280408, estimate(x), tolerance = 3 * 10 ^ -2)
  ...
  expect_equal(0.5057, estimate(x), tolerance = 3 * 10 ^ -2)
